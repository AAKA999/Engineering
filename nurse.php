...
<br> -->
   <form name="add" action="patient_list.php">
		<input class = "left" name = "visit_log" type="submit" value="Patient Info"></input>
   </form> 
   

   <form name="update" action="doctor_list.php">
   		<input class="right" name = "update_details" type="submit" value="Doctor Info"></input>
   </form>
</div>
</center>
<div id="footer">
