...
<table width = "100%" border="0px">
  ...
  <tr>
    ...
    <td>
      <input type = "text" name = "pname" value=<?php echo $pname;?> ></input>
    </td>
  </tr> 
  ...
  <tr>
    ...
    <td>
      <input type = "text" name = "pno"  value =<?php echo $phone;?> ></input>
    </td>
  </tr> 
</table>
<br>
...
<center><form><input type="submit" name ="edit" value="Submit"></input></form></center>


</form>
<center><form><input type="submit" name ="edit" value="Back" formaction="update_patient.php"></input></form></center>
