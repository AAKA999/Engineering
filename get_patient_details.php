...
<div>
<form name = "search" method="POST" action="show_details.php">
...
<center><form><input type="submit" name ="back" value="Profile Page" formaction="patient_list.php"></input></form></center>
